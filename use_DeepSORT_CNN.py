#!/usr/bin/env python
"""
Deep SORT face tracking (embedding CNN từ MARS) + logging + xuất CSV + video
"""
...
def verify_files():
    for p, desc in [(VIDEO_PATH,"Video"), (YOLO_WEIGHTS,"YOLO weights"), (DESCRIPTOR_MODEL,"MARS model")]:
